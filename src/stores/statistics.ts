...
import { ref } from 'vue'
import type { OverviewStats, RehearsalCountItem, SubstituteRateItem, ErrorPositionItem, AttendanceStatItem } from '@/types'
...
export const useStatisticsStore = defineStore('statistics', () => {
  ...
  async function fetchAll() {
    loading.value = true
    try {
      const [ov, rc, sr, ep, as] = await Promise.all([
  ...
  return { overview, rehearsalCounts, substituteRates, errorPositions, attendanceStats, loading, fetchAll }
})
